...
public class TinyDB {
    ...
    public ArrayList<ProductDetailsModel> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProductDetailsModel> playerList = new ArrayList<ProductDetailsModel>();

        for (String jObjString : objStrings) {
            ProductDetailsModel player = gson.fromJson(jObjString, ProductDetailsModel.class);
    ...
    public void putListObject(String key, ArrayList<ProductDetailsModel> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (ProductDetailsModel player : playerList) {
